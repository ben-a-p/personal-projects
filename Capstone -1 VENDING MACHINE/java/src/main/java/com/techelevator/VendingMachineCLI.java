...
public class VendingMachineCLI {
	...
	private static final String SALES_REPORT_MENU_OPTION_DELETE_A_SALES_REPORT = "Delete A Specific Sales Report";
	private static final String SALES_REPORT_MENU_OPTION_DELETE_ALL_SALES_REPORTS = "Delete All Sales Reports";
	...
	private static final String[] SALES_REPORT_MENU_OPTIONS = { SALES_REPORT_MENU_OPTION_PRINT_SALES_REPORT, SALES_REPORT_MENU_OPTION_DELETE_A_SALES_REPORT, 
			SALES_REPORT_MENU_OPTION_DELETE_ALL_SALES_REPORTS, SALES_REPORT_MENU_OPTION_QUIT };
		...
		while (done == false) {
			...
			if (choice.equals(MAIN_MENU_OPTION_DISPLAY_ITEMS)) {
				...
				while (salesReportDone == false) {
					...
					} else if (salesChoice.equals(SALES_REPORT_MENU_OPTION_DELETE_ALL_SALES_REPORTS)) {
						vendingMachine.deleteAllSalesReports();
						System.out.println("Deleting all sales reports");
